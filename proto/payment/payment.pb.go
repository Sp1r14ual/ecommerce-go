...
type PaymentRequest struct {
	...
	Amount        int64                  `protobuf:"varint,2,opt,name=amount,proto3" json:"amount,omitempty"` // Сумма к оплате
...
type PaymentResponse struct {
	...
	TransactionId string                 `protobuf:"bytes,2,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"` // ID транзакции в банковской системе (чисто для вида)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_payment_proto_rawDesc = "" +
	...
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponseB$Z\"ecommerce-go/proto/payment;paymentb\x06proto3"
